...
## What's New in v2.9 — infrastructure-level loop detection 🛡️

These changes land in the **agent loop** (`v2/src/core/`) and are shared automatically by the VS Code extension, the Electron app, and the CLI.
